...
public class Listing: Identifiable {
    ...
    public init(title: String, partType: String, make: String, model: String, year: String, trim: String, price: Double, description: String, city: String, phoneNumber: String) {
        self.title = title
